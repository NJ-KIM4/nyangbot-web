// CTA (Call to Action) 섹션 - 봇 초대 + 서버 참여
      ...
      <div className="max-w-3xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-10 py-4 border-2 border-brand-mint text-brand-mint rounded-full font-bold text-lg btn-bounce hover:bg-brand-mint hover:text-white transition-colors"
          >
            서버 참여하기
          </a>
        </div>
